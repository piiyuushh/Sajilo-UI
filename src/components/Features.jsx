...
const Features = () => {
  return (
    <section className="py-16 dark:bg-black bg-white border-t dark:border-[#252525] border-[#EBEBEB] ">
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white p-6  dark:bg-[#0A0A0A] border dark:border-[#252525] border-[#EBEBEB] rounded-lg "
            >
